...
"use strict";var waitForEl=function i(n,t){jQuery(n).length?t():setTimeout(function(){i(n,t)},100)};waitForEl(".wpgmza_infowindow_description",function(){jQuery(document).ready(function(i){i(".wpgmza_infowindow_description").html(i(".wpgmza_infowindow_description").text().substring(0,130)+"..."),i(".wpgmza_map").click(function(){i(".wpgmza_infowindow_description").html(i(".wpgmza_infowindow_description").text().substring(0,130)+"...")})})});